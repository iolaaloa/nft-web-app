...
// Import OpenZeppelin Contracts that are already written
...
contract MyEpicNFT  is ERC721URIStorage{
   ...
   //string baseSvg = "<svg xmlns='http://www.w3.org/2000/svg' preserveAspectRatio='xMinYMin meet' viewBox='0 0 350 350'><style>.base { fill: white; font-family: serif; font-size: 24px; }</style><rect width='100%' height='100%' fill='black' /><text x='50%' y='50%' class='base' dominant-baseline='middle' text-anchor='middle'>";
    ...
    string[] firstWords = ["Baobab", "Neem", "Odum", "Amarula", "Acacia"];
    string[] secondWords = ["Fruit", "Bark", "Root", "Leaf"];
    string[] thirdWords = ["Juice", "Powder", "Poultice", "Pills"];
  ...
  string[] colors = ["red", "#08C2A8", "black", "yellow", "blue", "green"];
    ...
    //Pass the NFT Token and its symbol
    constructor() ERC721("HERBAL", "HERB"){
  ...
  function random(string memory input) internal pure returns (uint256) {
    ...
    function makeAnEpicNFT() public {
        ...
        string memory json = Base64.encode(
            bytes(
                string(
                    ...
                    combinedWord,
                    '", "description": "A highly acclaimed collection of herbs.", "image": "data:image/svg+xml;base64,',
        ...
        // Set the NFTs data<- this is likely where I would add the geodata
        // or tree data; the token URI will have the tree data
       // _setTokenURI(newItemId, "data:application/json;base64,");
        ...
        // Console log to show when & who the nft was minted to
